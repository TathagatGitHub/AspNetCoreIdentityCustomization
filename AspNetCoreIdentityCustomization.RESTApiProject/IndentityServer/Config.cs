...
namespace IndentityServer
{
    ...
    public class Config
    {
        ...
        public static IEnumerable<ApiResource> GetApiResources()
        {
            ...
            {
                new  ApiResource("AspNetCoreIdentityCustomization.RESTApiProject", "My API")
            };
        }
        //Defining the client
        /**
        ...
        public static IEnumerable<Client> GetClients()
        {
            return new List<Client>
            {
                new Client
                {
                    ...
                    AllowedScopes = { "AspNetCoreIdentityCustomization.RESTApiProject"}
                },
                new Client
                {
                    ClientId = "AspNetCoreIdentityCustomization.RESTApiProjectClient",
